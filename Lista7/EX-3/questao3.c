...
int folhaNO_ArvBin(ArvBin *raiz){
    if(raiz == NULL || *raiz == NULL)
        return 0;
    if((*raiz)->esq == NULL && (*raiz)->dir == NULL)
     return 1;
     else{
    int alt_esq = folhaNO_ArvBin(&((*raiz)->esq));
    int alt_dir = folhaNO_ArvBin(&((*raiz)->dir));
...
int main()
{
    ...
    printf("O numero de folha nessa arvore e: %d ", folhaNO_ArvBin(raiz));
    return 0;
